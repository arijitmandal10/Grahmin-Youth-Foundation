...
// const images1 = [splide1, splide2, splide3, splide4, splide5, splide7, splide8];
// const images = [
// 	[splide1, splide2],
// 	[splide3, splide4],
// 	[splide5, splide6],
...
// 			<div>{/* create carousel mapping images1 for small screen devices */}</div>
// 		</div>
// 	);
// };
								...
								<div key={subIndex} className={styles.imageContainer}>
									<img
										style={{
											...
											width: window.innerWidth <= 768 ? '180px' : '750px',
											marginBottom: '10px',
										}}
										src={image}
										alt={`Image ${index + 1}-${subIndex + 1}`}
